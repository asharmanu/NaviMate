                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      ...
                                      options: [
                                        FFLocalizations.of(context).getText(
                                          'bjfg629m' /* Constructor University */,
                                        )
                                      ],
                                      onChanged: (val) => setState(() =>
                                          _model.universityDropDownValue = val),
                                      width: double.infinity,
                                      height: 53.0,
                                        ...
                                        children: [
                                          Expanded(
                                            child: AutoSizeText(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'g9k6virj' /* Nice outdoor courts, solid con... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
