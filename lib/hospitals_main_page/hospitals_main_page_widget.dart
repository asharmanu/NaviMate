...
import 'hospitals_main_page_model.dart';
export 'hospitals_main_page_model.dart';

class HospitalsMainPageWidget extends StatefulWidget {
  const HospitalsMainPageWidget({super.key});

  @override
  State<HospitalsMainPageWidget> createState() =>
      _HospitalsMainPageWidgetState();
}

class _HospitalsMainPageWidgetState extends State<HospitalsMainPageWidget> {
  late HospitalsMainPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HospitalsMainPageModel());
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    ...
                                    options: [
                                      FFLocalizations.of(context).getText(
                                        'itu5lgw3' /* Location - Near */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        '3o2f4nks' /* Reviews - Most like */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'nfhcwaz0' /* Work experience - Most */,
                                      )
                                    ],
                                    onChanged: (val) => setState(
                            ...
                            child: StreamBuilder<List<HospitalsRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<HospitalsRecord>
                                    columnHospitalsRecordList = snapshot.data!;
                                return Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: List.generate(
                                    ...
                                    final columnHospitalsRecord =
                                        columnHospitalsRecordList[columnIndex];
                                    return Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          8.0, 8.0, 8.0, 8.0),
                                      child: Material(
